...
namespace MapAppTest
{
    ...
    public class Core
    {
        public static async Task<Weather> GetWeather(double lat, double lon)
        {
            ...
            RootObject results = await DataServices.getDataFromServices(queryString).ConfigureAwait(false);
    ...
    {
        public static async Task<RootObject> getDataFromServices(string queryString)
        {
